export default function page(params) {
  return (
    <div className=" p-8  w-3/4 mx-auto ">
      ...
      <p className="text-gray-700 mb-4">
        O compromisso com soluções inovadoras e um atendimento próximo fez com que a empresa crescesse e se consolidasse, tornando-se um nome de confiança na região.
      </p>
      <p className="text-gray-700 mb-4">
        Com a experiência de anos no mercado e um conhecimento profundo das necessidades locais, a Futuro Consultoria hoje é uma referência em serviços especializados, oferecendo suporte estratégico para o crescimento de empresas, sempre alinhada com as melhores práticas do setor.
      </p>
