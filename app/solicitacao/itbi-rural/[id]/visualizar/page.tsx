                ...
                <div className="relative z-10 p-12 md:p-16 space-y-10 text-gray-800">
                    ...
                    <div className="flex justify-between items-start border-b-2 border-gray-100 pb-8">
                        ...
                        <div className="text-right">
                            ...
                            <div className="text-2xl font-mono font-bold text-blue-600">#{itbi.protocolo?.toUpperCase()}</div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-8 border border-gray-100">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-xl font-bold text-gray-900">
                                    {(itbi.taxaExpediente || 0).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}
                                </p>
                            </div>
