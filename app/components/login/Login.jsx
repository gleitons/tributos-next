...
import brasaoLagoaM from '@/public/brasao-lagoa-dos-patos-mg-a-min.jpg'
                ...
                <div className="leading-loose">
                    <div className="max-w-sm m-4 p-5 backMac rounded shadow-xl h-82 ">
                        <div className="brasao">
                            <Image src={dob} quality={10} width={150} height={200} priority className="hover:scale-105  " alt="brasao Lagoa dos Patos MG" />
                        </div>
